...
def result_of_prediction(pred, mode):
    if mode == 1:
        ...
        if pred == 1:
            return "Yes, the employee may depart from the organization"
        else:
...
def employee_eda():
    return render_template(
        ...
        employee_paiplots = url_for('static', filename='employee_pairplot.png'),
...
def result1():
    ...
    scaler_path= r"C:\Users\suman\Downloads\customer_churn_prediction\models\sc.sav"
    model_path=r"C:\Users\suman\Downloads\customer_churn_prediction\models\rf.sav"
...
def result2():
    ...
    scaler_path2= r"C:\Users\suman\Downloads\customer_churn_prediction\models\sc_employee.sav"
    model_path2=r"C:\Users\suman\Downloads\customer_churn_prediction\models\rf_employee.sav"
